    ...
    return (
        <main className="flex-1 p-6 md:p-10 overflow-y-auto bg-slate-50 font-sans">
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                {/* Next Lesson Focus */}
                <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 md:p-10 text-white relative overflow-hidden shadow-2xl">
                            ...
                            <div className="grid grid-cols-7 gap-2">
                                {calendarDays.map((cell, idx) => (
                                    <div
                                        ...
                                        className={cn(
                                            "min-h-[80px] p-2 rounded-xl transition-all relative border",
                                            cell.empty
                            ...
                            <div className="flex-1 overflow-y-auto pr-2 space-y-4 max-h-[500px]">
                                {schedule.map((lesson) => (
                                    <div
                                        ...
                                        className="p-4 rounded-2xl border border-slate-100 bg-slate-50 hover:bg-white hover:border-indigo-200 transition-colors cursor-pointer group flex flex-col gap-2"
                                    >
                            ...
                            <div className="px-10 py-8 border-b border-slate-100 flex justify-between items-center bg-slate-50/30 shrink-0">
                                <div>
                                    <div className="flex items-center gap-3">
                                        <h2 className="text-2xl font-black text-slate-900">授業詳細・カルテ</h2>
                                        <span className={cn(
                                    ...
                                    <p className="text-xs font-bold text-slate-500 mt-1">{selectedLesson.date} • {selectedLesson.time} ({selectedLesson.duration})</p>
                                </div>
                                <button
                            ...
                            <div className="flex-1 overflow-y-auto p-10 space-y-8 min-h-0">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">担当講師</p>
                                        <div className="flex items-center gap-2">
                                            <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 text-xs font-black">
                                                {selectedLesson.teacherName[0]}
                                            </div>
                                            <p className="font-bold text-slate-900">{selectedLesson.teacherName} 先生</p>
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">コース</p>
                                        <p className="font-bold text-slate-900">{selectedLesson.course}</p>
                                    </div>
                                </div>
