...
const GRADES_DATA = [
    {
        ...
        topics: [
            { title: '英語を始める前に', pdfName: '0英語を始める前に.pdf', status: 'ready' },
            { title: 'be動詞', pdfName: '1be動詞.pdf', status: 'ready' },
            { title: '一般動詞(現在形)', pdfName: '2一般動詞.pdf', status: 'ready' },
            { title: '三人称単数現在', pdfName: '3三人称単数現在.pdf', status: 'ready' },
            { title: '代名詞', pdfName: '4代名詞.pdf', status: 'ready' },
            { title: '疑問詞', pdfName: '5疑問詞.pdf', status: 'ready' },
            { title: '命令文', pdfName: '6命令文.pdf', status: 'ready' },
